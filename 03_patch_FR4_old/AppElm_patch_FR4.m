...
[Fres_base, Smin_base] = find_F_res(Sparam_base, 1e9, 1.75e9);
...
Fres_5 = ((y_data(7) - y_data(5))/2)
Fres_10 = ((y_data(8) - y_data(4))/2)
Fres_25 = ((y_data(11) - y_data(1))/2)
%% Minimum S11
x_data = dvar/var_base*100;
...
Smin_5 = ((y_data(7) - y_data(5))/2)
Smin_10 = ((y_data(8) - y_data(4))/2)
Smin_25 = ((y_data(11) - y_data(1))/2)
%% Bande passante
x_data = dvar/var_base*100;
...
BW_5 = ((y_data(7) - y_data(5))/2)
BW_10 = ((y_data(8) - y_data(4))/2)
BW_25 = ((y_data(11) - y_data(1))/2)
%% Save
if save
